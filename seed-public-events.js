  ...
  try {
    ...
    const events = [
      ...
      },
      {
        ...
        type: 'VOLUNTEERING',
        status: 'UPCOMING',
        startDate: new Date('2025-02-20T18:00:00Z'),
        endDate: new Date('2025-02-20T21:00:00Z'),
        location: JSON.stringify({
      ...
      },
      {
        ...
        type: 'WORKSHOP',
        status: 'UPCOMING',
        startDate: new Date('2025-03-01T07:00:00Z'),
      ...
      },
      {
        ...
        type: 'VOLUNTEERING',
        status: 'UPCOMING',
        startDate: new Date('2025-03-10T08:00:00Z'),
      ...
      },
      {
        ...
        type: 'WORKSHOP',
        status: 'UPCOMING',
        startDate: new Date('2025-02-28T19:00:00Z'),
        endDate: new Date('2025-02-28T21:00:00Z'),
        location: JSON.stringify({
      ...
      },
      {
        ...
        type: 'WORKSHOP',
        status: 'UPCOMING',
        startDate: new Date('2025-03-05T15:00:00Z'),
        endDate: new Date('2025-03-05T18:00:00Z'),
        location: JSON.stringify({
      ...
      },
      {
        ...
        endDate: new Date('2025-03-15T13:00:00Z'),
        location: JSON.stringify({
