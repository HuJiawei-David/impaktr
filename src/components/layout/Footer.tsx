...
export function Footer() {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-gray-900">
      ...
      <div className="relative py-16 bg-gradient-to-br from-gray-900 via-slate-800 to-gray-800 dark:from-gray-950 dark:via-slate-900 dark:to-gray-900 overflow-hidden">
        {/* Dreamy animated background elements - Same as Hero */}
        <div className="absolute inset-0 overflow-hidden">
          {/* Large dreamy floating bubbles with glow */}
          <div className="absolute top-8 left-8 w-12 h-12 bg-gradient-to-br from-blue-400/30 to-cyan-400/20 rounded-full shadow-2xl shadow-blue-400/20 animate-bounce blur-sm" style={{ animationDelay: '0s', animationDuration: '6s' }}></div>
          <div className="absolute top-20 right-12 w-10 h-10 bg-gradient-to-br from-purple-400/35 to-pink-400/25 rounded-full shadow-2xl shadow-purple-400/25 animate-bounce blur-sm" style={{ animationDelay: '1s', animationDuration: '7s' }}></div>
          <div className="absolute bottom-16 left-16 w-8 h-8 bg-gradient-to-br from-emerald-400/40 to-teal-400/30 rounded-full shadow-2xl shadow-emerald-400/20 animate-bounce blur-sm" style={{ animationDelay: '2s', animationDuration: '5.5s' }}></div>
          <div className="absolute top-1/2 left-8 w-16 h-16 bg-gradient-to-br from-cyan-400/25 to-blue-400/20 rounded-full shadow-2xl shadow-cyan-400/15 animate-bounce blur-sm" style={{ animationDelay: '0.5s', animationDuration: '8s' }}></div>
          <div className="absolute bottom-8 right-8 w-11 h-11 bg-gradient-to-br from-violet-400/30 to-purple-400/25 rounded-full shadow-2xl shadow-violet-400/20 animate-bounce blur-sm" style={{ animationDelay: '1.5s', animationDuration: '6.5s' }}></div>
          <div className="absolute top-8 right-1/3 w-6 h-6 bg-gradient-to-br from-teal-400/35 to-emerald-400/30 rounded-full shadow-2xl shadow-teal-400/25 animate-bounce blur-sm" style={{ animationDelay: '2.5s', animationDuration: '7.5s' }}></div>
          
          {/* Extra large dreamy bubbles */}
          <div className="absolute top-1/4 left-1/4 w-20 h-20 bg-gradient-to-br from-blue-300/15 to-indigo-300/10 rounded-full shadow-2xl shadow-blue-300/10 animate-pulse blur-md" style={{ animationDelay: '0s', animationDuration: '10s' }}></div>
          <div className="absolute bottom-1/4 right-1/4 w-16 h-16 bg-gradient-to-br from-purple-300/18 to-pink-300/12 rounded-full shadow-2xl shadow-purple-300/12 animate-pulse blur-md" style={{ animationDelay: '3s', animationDuration: '12s' }}></div>
          <div className="absolute top-3/4 left-3/4 w-14 h-14 bg-gradient-to-br from-emerald-300/16 to-cyan-300/11 rounded-full shadow-2xl shadow-emerald-300/11 animate-pulse blur-md" style={{ animationDelay: '1.5s', animationDuration: '9s' }}></div>
          
          {/* Massive dreamy orbs */}
          <div className="absolute top-1/3 right-1/5 w-28 h-28 bg-gradient-to-br from-rose-300/12 to-pink-300/8 rounded-full shadow-2xl shadow-rose-300/8 animate-pulse blur-lg" style={{ animationDelay: '4s', animationDuration: '15s' }}></div>
          <div className="absolute bottom-1/3 left-1/5 w-24 h-24 bg-gradient-to-br from-indigo-300/14 to-blue-300/9 rounded-full shadow-2xl shadow-indigo-300/9 animate-pulse blur-lg" style={{ animationDelay: '6s', animationDuration: '13s' }}></div>
          
          {/* Enhanced gradient orbs with dreamy effects */}
          <div className="absolute -top-20 -right-16 w-64 h-64 bg-gradient-to-br from-emerald-500/25 to-teal-500/15 rounded-full blur-3xl animate-pulse opacity-60 shadow-2xl shadow-emerald-500/10" style={{ animationDuration: '16s' }}></div>
          <div className="absolute top-20 -left-16 w-56 h-56 bg-gradient-to-br from-blue-500/25 to-cyan-500/15 rounded-full blur-3xl animate-pulse opacity-50 shadow-2xl shadow-blue-500/10" style={{ animationDelay: '2s', animationDuration: '18s' }}></div>
          <div className="absolute -bottom-16 right-1/3 w-48 h-48 bg-gradient-to-br from-violet-500/25 to-purple-500/15 rounded-full blur-3xl animate-pulse opacity-70 shadow-2xl shadow-violet-500/10" style={{ animationDelay: '4s', animationDuration: '14s' }}></div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-12">
              ...
              <h3 className="text-2xl md:text-4xl font-bold mb-4 text-white">
                <span className="text-white">Stay</span> <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">Updated</span>
              </h3>
