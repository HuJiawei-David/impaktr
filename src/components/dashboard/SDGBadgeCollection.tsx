        ...
        <CardContent className="p-4 pt-0">
          ...
          <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-700">
            <Link href="/profile?tab=badges" className="block w-full">
              <div className="group relative w-full p-3 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 border border-blue-200/50 dark:border-blue-800/50 hover:from-blue-100 hover:to-purple-100 dark:hover:from-blue-950/30 dark:hover:to-purple-950/30 transition-all duration-200 cursor-pointer">
